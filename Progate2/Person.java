class Person {
  ...
  // コンストラクタを書き換えてください
  Person(String firstName, String lastName, String job, int age, double height, double weight) {
    Person.count++;
  ...
  // コンストラクタを書き換えてください
  Person(String firstName, String middleName, String job, String lastName, int age, double height, double weight) {
    this(firstName, lastName, job, age, height, weight);
